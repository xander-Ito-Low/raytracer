...
public:
    ...
    void compute_photonDiffuse(Vector &normal, Vector &ldir,Colour &inColour ,Colour &result);
    
    void compute_photonCaustic(Vector &normal, Vector &ldir,Colour &inColour ,Colour &result);

    void get_diffuse(Colour &result);
       
    void get_specular(Colour &result);
    
    void get_ambient(Colour &result);
};
